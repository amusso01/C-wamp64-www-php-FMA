                             ...
                             <fieldset>
                                 ...
                                 <div>
                                     ...
                                     <input type="text" name="userName" value="';if (isset($cleanForm['userName'])) {
                                         ...
                                         echo'<span class="hint">Must be min 5 characters and max 12. At least 2 digit.</span>';};echo'
                                 ...
                                 <div>
                                     ...
                                     <input type="text" name="password" id="password">';if(isset($errorForm['password'])){
                                         ...
                                         echo'<span class=\'hint\'>Combination of characters and digit with at least 1 capital and 1 lower letter</span>';
                                     }echo'
                                 </div>
                                 <div>
